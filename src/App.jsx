           ...
           <div className="absolute -left-6 bottom-16 hidden lg:block">
             ...
             {waOpen && (
               <div className="absolute bottom-full mb-3 left-0 bg-white rounded-2xl shadow-2xl border border-primary/10 p-3 flex flex-col gap-2 min-w-[220px]">
                 <a
                   href={`https://wa.me/5491177170405?text=${encodeURIComponent('Hola, quería más información sobre una propiedad.')}`}
                   target="_blank" rel="noopener noreferrer"
                   className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-[#25D366]/10 text-primary font-heading font-semibold text-sm transition-colors whitespace-nowrap"
                 >
                   {WA_SVG} Villa Ballester
                 </a>
                 <a
                   href={`https://wa.me/5491177176007?text=${encodeURIComponent('Hola, quería más información sobre una propiedad.')}`}
                   target="_blank" rel="noopener noreferrer"
                   className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-[#25D366]/10 text-primary font-heading font-semibold text-sm transition-colors whitespace-nowrap"
                 >
                   {WA_SVG} San Martín
             ...
             <button
               ...
               className="bg-white p-6 rounded-2xl shadow-xl border border-primary/5 animate-bounce cursor-pointer hover:shadow-2xl transition-shadow"
